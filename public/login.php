...
<head>
    ...
    <!-- Caminho relativo para a pasta de estilos -->
    <link rel="stylesheet" href="../styles/style.css">
</head>
<body class="bg-light">
    <div class="main-container">
        <!-- Topo da Aplicação -->
        <nav class="navbar navbar-dark navbar-ismaga bg-dark py-3">
            <div class="container justify-content-center">
                <h2 class="m-0 text-white"><strong>+ Já</strong>.Ismaga</h2>
            </div>
        </nav>
                    ...
                    <div class="col-12 col-sm-8 col-md-6 col-lg-4">
                        ...
                        <div class="card shadow-lg border-0 p-4">
                            <div class="card-body">
                                ...
                                <!-- Formulário estruturado com acao POST -->
                                <form id="loginForm" action="login-valida.php" method="POST">
                                    <div class="mb-3 text-start">
                                        <label for="email" class="form-label fw-semibold">E-mail</label>
                                        <input type="email" class="form-control" id="email" name="email" placeholder="exemplo@ismaga.com" required>
                                    </div>
